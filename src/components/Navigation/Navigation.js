      ...
      <nav>
        <div className={styles.Navigation}>
          ...
          >
            ...
            <p className="Navigation__name Navigation__name--dashboard">
              Dashboard
            </p>

            {!isLoggedIn && (
              <svg
                className={styles.Navigation__iconArrow}
                width="16"
                height="16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <p className="Navigation__name Navigation__name--product">
              Product
            </p>
            {isLoggedIn && (
              <svg
          ...
          >
            ...
            <p className="Navigation__name Navigation__name--customers">
              Customers
            </p>
            {isLoggedIn && (
              <svg
          ...
          >
            ...
            <p className="Navigation__name Navigation__name--income">Income</p>
            {isLoggedIn && (
              <svg
                className={styles.Navigation__iconArrow}
                width="16"
          ...
          >
            ...
            <p className="Navigation__name Navigation__name--promote">
              Promote
            </p>
            {isLoggedIn && (
              <svg
          ...
          >
            ...
            <p className="Navigation__name Navigation__name--help">Help</p>
            {isLoggedIn && (
              <svg
                className={styles.Navigation__iconArrow}
                width="16"
